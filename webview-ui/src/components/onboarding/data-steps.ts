...
export const USER_TYPE_SELECTIONS: UserTypeSelection[] = [
	...
	{ title: "Bring my own API key", description: "Use Ritivel with your provider of choice", type: NEW_USER_TYPE.BYOK },
]
