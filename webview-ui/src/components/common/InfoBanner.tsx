	...
	if (usePlatform().type === PlatformType.VSCODE) {
		return (
			<a
				...
				target="_blank">
				<h4 className="m-0">💡 Ritivel in the Right Sidebar</h4>
				<p className="m-0">
					Keep your files visible when chatting with Ritivel. Drag the Ritivel icon to the right sidebar panel for a
