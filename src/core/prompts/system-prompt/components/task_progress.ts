...
- Keep items focused on meaningful progress milestones rather than minor technical details. The checklist should not be so granular that minor document editing details clutter the progress tracking.
...
Example:
<read_file>
<path>IND_submission_draft.md</path>
<task_progress>
- [x] Review existing IND document structure
- [x] Gather clinical trial data
- [ ] Update clinical trial data section
- [ ] Add manufacturing compliance information
- [ ] Verify regulatory formatting
</task_progress>
</read_file>`
