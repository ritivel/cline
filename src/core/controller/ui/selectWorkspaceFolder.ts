...
/**
 * Selects a workspace folder for regulatory product setup
 * @param controller The controller instance
 * @param request Empty request
 * @returns String response with the selected folder path
 */
export async function selectWorkspaceFolder(_controller: Controller, _request: EmptyRequest): Promise<String> {
